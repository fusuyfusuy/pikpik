...
import { Database, CreateDatabaseRequest, DatabaseEngine } from '../lib/types';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-zinc-400 mt-0.5">
            Isolated SQL and NoSQL engines with persistent volumes & automated backup integration
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {databases.map((db) => (
            <Card key={db.id} className="flex flex-col justify-between hover:border-zinc-700">
              ...
              <div className="flex items-center justify-between gap-2 pt-4 mt-4 border-t border-zinc-800/60">
                <Button
                  variant="outline"
                  size="sm"
